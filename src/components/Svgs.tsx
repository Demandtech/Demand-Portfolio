...
export function LinkedInIcon(props: IconSvgProps) {
  return (
    <svg
      className="Sidebar_icons__QiJxg"
      fill="none"
      height="24px"
      stroke="currentColor"
      strokeLinecap="round"
...
export function EmailIcon(props: IconSvgProps) {
  return (
    <svg
      className="Sidebar_icons__QiJxg"
      fill="none"
...
export function DownloadIcon(props: IconSvgProps) {
  return (
    ...
    >
      <g>
        <path
          d="M154.389,265.602c0.351,0.35,0.719,0.683,1.103,0.997c0.169,0.138,0.347,0.258,0.52,0.388
      ...
      L154.389,265.602z"
        />
        <path d="M315,300H15c-8.284,0-15,6.716-15,15s6.716,15,15,15h300c8.284,0,15-6.716,15-15S323.284,300,315,300z" />
      </g>
    </svg>
  );
}
...
export function RepoIcon(props: IconSvgProps) {
  return (
    <svg
      height="20"
...
export function EmptyIcon(props: IconSvgProps) {
  return (
    <svg
